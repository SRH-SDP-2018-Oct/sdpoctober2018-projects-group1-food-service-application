...
public class NotificationPage {
	...
	public static void notificationPageFSA(FSA loggedInfsa) throws SQLException, NoSuchAlgorithmException, ParseException {
		int page;
	...
	public static void notificationPageCustomer(Customer loggedInCustomer) throws SQLException, NoSuchAlgorithmException, ParseException {
		int page;
	...
	public static void readFSANotificationDetail(String receivername,FSA loggedInfsa) throws SQLException, NoSuchAlgorithmException, ParseException {
	...
	public static void readCustomerNotificationDetail(String receivername,Customer loggedInCustomer) throws SQLException, NoSuchAlgorithmException, ParseException {
	...
	public static void backToFSANotification(FSA loggedInfsa) throws SQLException, NoSuchAlgorithmException, ParseException {
		
		notificationPageFSA(loggedInfsa);
	
	}
	
	public static void backToCustomerNotification(Customer loggedInCustomer) throws SQLException, NoSuchAlgorithmException, ParseException {
		
		notificationPageCustomer(loggedInCustomer); 
	
	}
	
	public static void backToFSARead(String username,FSA loggedInfsa) throws SQLException, NoSuchAlgorithmException, ParseException {
		String reply;
	...
	public static void backToCustomerRead(String username, Customer loggedInCustomer) throws SQLException, NoSuchAlgorithmException, ParseException {
		String reply;
		Scanner scanner6 = new Scanner(System.in);
		while(true) {
	...
	public static void backToFSAMenu() throws SQLException, NoSuchAlgorithmException, ParseException {
		MenuFsa.Overview();
	}
	public static void backToCustomerMenu() throws SQLException, NoSuchAlgorithmException, ParseException {
