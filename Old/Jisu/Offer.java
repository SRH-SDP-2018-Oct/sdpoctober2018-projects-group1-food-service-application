...
public class Offer {
	...
	public void setoffer(int foodid, Date date) throws ClassNotFoundException, IllegalArgumentException, IllegalAccessException{
		...
		for(int i=0; i<fieldlist.length; i++) {
			if(fieldlist[i].getName().equals("date")) {
				...
				fieldlist[i].set(this, "ash2"); // should be fixed
			}
			else {
