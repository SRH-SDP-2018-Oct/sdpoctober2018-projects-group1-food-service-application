...
public class MenuPageFsa {
	...
	public static void decisioner(FSA loggedInFsa) throws NoSuchAlgorithmException, ParseException, SQLException, ClassNotFoundException, IllegalArgumentException, IllegalAccessException {
	...
	public static void Overview() throws NoSuchAlgorithmException, ParseException, SQLException, ClassNotFoundException, IllegalArgumentException, IllegalAccessException{
		...
		case 1: FsaHomepage.fsaMain(loggedInfsa);
		break;
		case 2: 
