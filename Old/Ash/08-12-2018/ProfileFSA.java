...
public class ProfileFSA {
	...
	public static void decisioner(FSA loggedInFsa) throws NoSuchAlgorithmException, SQLException, ParseException, ClassNotFoundException, IllegalArgumentException, IllegalAccessException {
		loggedInfsa = loggedInFsa;
		fsaProfileUpdate();
		
	}

    public static void fsaProfileUpdate() throws NoSuchAlgorithmException, SQLException, ParseException, ClassNotFoundException, IllegalArgumentException, IllegalAccessException{
