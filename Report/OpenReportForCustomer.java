...
public class OpenReportForCustomer {
	
	public static void main(String[] args) {
		OpenReportForCustomer OpenreportCustomer = new OpenReportForCustomer();
		String newQuery = OpenreportCustomer.generateQuery();		
		OpenreportCustomer.generateReport(newQuery);
		...
		try {
			...
			report
			  ...
			  .title(//title of the report
			      Components.text("Customer Open Report"))
