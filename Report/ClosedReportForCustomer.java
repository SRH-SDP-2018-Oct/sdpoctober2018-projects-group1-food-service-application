...
public class ClosedReportForCustomer {
	
	public static void main(String[] args) {
		ClosedReportForCustomer ClosedreportCustomer = new ClosedReportForCustomer();
		String newQuery = ClosedreportCustomer.generateQuery();		
		ClosedreportCustomer.generateReport(newQuery);
		...
		try {
			...
			report
			  ...
			  .title(//title of the report
			      Components.text("Customer Closed Report"))
